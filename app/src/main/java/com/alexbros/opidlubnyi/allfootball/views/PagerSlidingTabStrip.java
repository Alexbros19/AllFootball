...
//	// @formatter:on
    ...
    private int indicatorColor = ResourcesCompat.getColor(getResources(), R.color.colorAccent, null);
    //private int underlineColor = 0x1A000000;
    //private int dividerColor = Colors.grayColorThird;

    private boolean expandHack = false;
    private int[] expandHackWeights;
    ...
    private int tabPaddingLeftRight = 10;
    private int tabPaddingTop = 6;
    private int tabPaddingBottom = 7;
    private int dividerWidth = 0;

    private int tabTextSize = 13;
    private int tabTextColor = Color.WHITE;
    private int tabDeactivateTextColor = 0x99ffffff;

    //private Typeface tabTypeface = null;
    //private int tabTypefaceStyle = Typeface.BOLD;

    private int lastScrollX = 0;
    private Typeface tabTypeface = Typeface.create("sans-serif-condensed", Typeface.NORMAL);
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        int color = PreferenceHelper.getToolBarColor(context);
...
//		indicatorColor = Colors.greenColorFirst;
        //underlineColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, underlineColor);
//		dividerColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsDividerColor, dividerColor);
//		dividerColor = Colors.grayColorThird;
    ...
    public void notifyDataSetChanged() {
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                //Log.d(VIEW_LOG_TAG, "OnGlobalLayoutListener1: " + getWidth());
                //Log.d(VIEW_LOG_TAG, "OnGlobalLayoutListener2: " + tabsContainer.getWidth());

                if (!expandHack && getWidth() == tabsContainer.getWidth()) {
                    //Log.d(VIEW_LOG_TAG, "switch to expandedTabLayoutParams");
                    expandHackWeights = new int[tabsContainer.getChildCount()];
                    for (int i = 0; i < expandHackWeights.length; i++) {
                        expandHackWeights[i] = tabsContainer.getChildAt(i).getWidth();
                    }
                    ...
                    scrollToChild(currentPosition, 0, expandHack);
                }
            }
        });
    }
...
//	}
    ...
    private void addTab(final int position, View tab) {
        ...
        if (expandHack) {
            if (expandHackWeights != null && expandHackWeights.length > position && expandHackWeights.length > 3)
                tab.setLayoutParams(new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, expandHackWeights[position]));
            else
...
//	}
    ...
    private void scrollToChild(int position, int offset, boolean force) {
        ...
        if (force || (newScrollX != lastScrollX)) {
...
//			if (dividerPaint != null && i < tabCount - 1)
//				canvas.drawLine(tab.getRight(), dividerPadding, tab.getRight(), height - dividerPadding, dividerPaint);

            if (tab instanceof TextView) {
                //Log.d(VIEW_LOG_TAG, i + "/" + currentPosition + "/" + currentPositionOffset);
                if ((i == currentPosition && currentPositionOffset == 0)) {
                    //((TextView) tab).setTypeface(tabTypeface, tabTypefaceStyle);
                    ((TextView) tab).setTextColor(tabTextColor);
                } else {
                    //((TextView) tab).setTypeface(tabTypeface, Typeface.NORMAL);
                    ((TextView) tab).setTextColor(tabDeactivateTextColor);
                }
            }
        }
    }
    ...
    private class PageListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            scrollToChild(position, (int) (positionOffset * tabsContainer.getChildAt(position).getWidth()), false);
